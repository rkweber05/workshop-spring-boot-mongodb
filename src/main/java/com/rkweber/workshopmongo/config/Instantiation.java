package com.rkweber.workshopmongo.config;
...
import com.rkweber.workshopmongo.dto.AuthorDTO;
import com.rkweber.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		userRepository.deleteAll(); // vai limpar a coleção la no mongodb
